  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 w-full">
      ...
      <div className="space-y-2 text-center mb-8">
        ...
        <p className="text-sm text-muted font-medium">Continue to your CAD workspace</p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          fullWidth
        />
        <p className="text-xs text-muted">We'll never share your email address.</p>
      </div>
      ...
      <div className="flex items-center justify-between">
        <label className="flex items-center gap-3 cursor-pointer group">
          <input
            ...
            className="w-4 h-4 rounded border border-border bg-card checked:bg-gradient-to-r checked:from-primary checked:to-primary/80 checked:border-primary cursor-pointer transition-all duration-200 hover:border-primary/60"
          />
